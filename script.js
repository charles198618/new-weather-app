...
let changeCity = document.querySelector("#change"); //How to change the city
changeCity.addEventListener("click", () => {
  city = prompt("what city");
  receiveCityTemp(city);
});

receiveCityTemp = function(city) {
  const url =
    "https://api.openweathermap.org/data/2.5/weather?q=" +
    city +
    "&appid=8b5e0537b2b17abc10e53b7116cb33e1&units=imperial";
